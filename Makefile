...
TARGET_NAME      := TeensyLogger
BOARD_ID         := TEENSY41

MCU              := imxrt1062

LIBS_SHARED_BASE := C:\Users\AUSTIN~1\DOCUME~1\Arduino\LIBRAR~1
LIBS_SHARED      := 

LIBS_LOCAL_BASE  := lib
LIBS_LOCAL       := SD SPI 

CORE_BASE        := C:\arduino-1.8.13\hardware\teensy\avr\cores\teensy4
GCC_BASE         := C:\arduino-1.8.13\hardware\tools\arm\bin
UPL_PJRC_B       := C:\arduino-1.8.13\hardware\tools
UPL_TYCMD_B      := C:\arduino-1.8.13\hardware\tools
